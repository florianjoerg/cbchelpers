...
#################################################################################
    @staticmethod
    def from_scratch(datafile: str | None = None, data = None, n_exp: int=3, name: str | None = None, outfile: str | None=None, maxtime: float | None=None, fit_model: str | None =None, boxl: float | None = None, slope_options: list | None = None) -> InputClass:#[0.0, True]):
    ...
    def __init__(self):
        ...
        self.outfile = ''
        self.maxtime = 0
        self.data = None #if no infile but the data is directly given, numpy array with x,y
